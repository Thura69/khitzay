...
function FilterDesktop({ initialData,setMenCheck,setWomenCheck,setKidsCheck,setAccessoriesCheck,setApparelCheck,setFootwearCheck }) {
  ...
  return (
      <div className='z-20   bg-gray-50 '>
          ...
          {/* Gender */}
          <ul className=''>
              <li className=' select-none cursor-pointer py-4 font-bold text-sm  flex items-center px-4 gap-2' onClick={handleGender}><AiOutlineDown size={"15px"} />GENDER</li>  
              {/* GenderMenu */}
              <ul ref={GenderRef} className=' overflow-hidden border-b h-auto'>
              ...
              {/* Category */}
              <li onClick={handelCategory} className='py-4 font-bold text-sm  flex items-center px-4 gap-2 select-none cursor-pointer'><AiOutlineDown size={"15px"} />CATEGORY</li> 
              {/* CategoryMenu */}
                <ul ref={CategoryRef} className=' border-b overflow-hidden h-auto'>
                  <li className='flex justify-between items-center py-4 px-4'>
                      <div className='flex items-center gap-4 font-light  '>
                          {
